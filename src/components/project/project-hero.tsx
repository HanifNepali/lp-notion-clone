  ...
  return (
    <section className="py-20">
      <Container variant="page" className="flex flex-col items-start">
        ...
        <h1 className="mt-6 max-w-3xl text-[40px] font-bold leading-11 tracking-[-1px] text-ink sm:text-[56px] sm:leading-[60px]">
          {projectContent.hero.title}
        </h1>
        <p className="mt-6 max-w-2xl text-lg leading-7 text-ink/85">
